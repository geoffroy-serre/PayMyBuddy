...
(
    ...
    INDEX `fk_transactions_User1_idx`
(
    `id_receiver` ASC
) VISIBLE,
    INDEX `fk_transactions_User2_idx`
(
    `id_sender` ASC
) VISIBLE,
...
(
    ...
    INDEX `fk_Friendlists_User1_idx`
(
    `id_user` ASC
) VISIBLE,
    INDEX `fk_Friendlists_User2_idx`
(
    `id_user2` ASC
) VISIBLE,
